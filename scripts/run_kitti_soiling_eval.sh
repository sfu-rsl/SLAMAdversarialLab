...
CONFIG="configs/slamadversariallab/experiments/kitti/kitti_soiling_all_severities.yaml"
...
for algo in "${ALGORITHMS[@]}"; do
    ...
    echo "------------------------------------------"
    python -m slamadversariallab evaluate "$CONFIG" --slam "$algo" --mode metrics-only --paper
done
