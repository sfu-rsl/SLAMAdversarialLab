"""Segment-windowed trajectory error, for the recovery experiment (E5).

E5 releases a stress pulse mid-run and asks which designs come back. The
...
Default is ``segment`` because E5's primary metric already handles the case
