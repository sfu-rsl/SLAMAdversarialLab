...
class S3POGSAlgorithm(SLAMAlgorithm):
    ...
    def _run_container_with_total_fps_stop(
        ...
        # Observed twice under E4NW's warmup_frames=0, where s3pogs received 2-5
        # frames out of 200.
        ...
        # 7200 s wait below runs to the full two hours. Under E4NW's
        # warmup_frames=0 this fired for real: s3pogs received 2-5 frames, evo's
