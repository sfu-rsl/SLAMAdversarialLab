...
See ``docs/fuzzy-slam/hami/HAMI_RUNTIME_MUTATION_INVESTIGATION.md`` in the
working repository (not part of the public distribution) for the full mechanism,
DWARF-extracted byte offsets, and the validation script that proved it
works on hardware.
...
# libvgpu.so (HAMi-core commit 94fff56). See
# docs/fuzzy-slam/hami/HAMI_RUNTIME_MUTATION_INVESTIGATION.md §3 for derivation.
...
class GpuHamiController(ResourceController):
    ...
    See module docstring + docs/fuzzy-slam/hami/HAMI_RUNTIME_MUTATION_INVESTIGATION.md
